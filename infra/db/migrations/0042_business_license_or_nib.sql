-- 0042_business_license_or_nib.sql
-- Business CDD submit: "Nomor Izin Usaha (NIB/OSS/SIUP/dll)" hanya satu field di form.
-- Cukup salah satu dari business_license_number ATAU nib yang terisi — tidak wajib
-- keduanya. Sisanya identik dengan 0041 (dokumen wajib + kondisional). Idempotent.
