-- 0037_import_full_regions.sql
-- Seed kab/kota lengkap Indonesia (514 wilayah) per Kemendagri/BPS 2024.
-- Kecamatan: seed parsial — hanya Bandar Lampung (20) + existing test data.
-- Desa/Kelurahan: seed parsial — hanya Kecamatan Enggal Bandar Lampung + existing test data.
-- Full kecamatan + desa/kelurahan: import via `npm run db:seed:regions` dari CSV.
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('1206','12','Kabupaten Toba','KABUPATEN'),
  ('1207','12','Kabupaten Labuhanbatu','KABUPATEN'),
  ...
  ('1222','12','Kabupaten Labuhanbatu Selatan','KABUPATEN'),
  ('1223','12','Kabupaten Labuhanbatu Utara','KABUPATEN'),
  ('1224','12','Kabupaten Nias Utara','KABUPATEN'),
  ('1225','12','Kabupaten Nias Barat','KABUPATEN'),
  ('1271','12','Kota Sibolga','KOTA'),
  ('1272','12','Kota Tanjungbalai','KOTA'),
  ('1273','12','Kota Pematangsiantar','KOTA'),
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('1373','13','Kota Sawahlunto','KOTA'),
  ('1374','13','Kota Padangpanjang','KOTA'),
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('1405','14','Kabupaten Siak','KABUPATEN'),
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('1504','15','Kabupaten Batanghari','KABUPATEN'),
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('1607','16','Kabupaten Banyuasin','KABUPATEN'),
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('1808','18','Kabupaten Tulang Bawang','KABUPATEN'),
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('1971','19','Kota Pangkalpinang','KOTA')
ON CONFLICT (code) DO NOTHING;
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('2171','21','Kota Batam','KOTA'),
  ('2172','21','Kota Tanjungpinang','KOTA')
ON CONFLICT (code) DO NOTHING;

-- ── Jawa ──────────────────────────────────────────────────────────────────────
-- DKI Jakarta (31) — already seeded in 0035, idempotent
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('3403','34','Kabupaten Gunungkidul','KABUPATEN'),
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('5107','51','Kabupaten Karangasem','KABUPATEN'),
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('6302','63','Kabupaten Kotabaru','KABUPATEN'),
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('6411','64','Kabupaten Mahakam Ulu','KABUPATEN'),
...
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ...
  ('7110','71','Kabupaten Bolaang Mongondow Timur','KABUPATEN'),
  ('7111','71','Kabupaten Bolaang Mongondow Selatan','KABUPATEN'),
...
-- Sulawesi Barat (76)
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ('7601','76','Kabupaten Mamuju','KABUPATEN'),
  ('7602','76','Kabupaten Polewali Mandar','KABUPATEN'),
  ('7603','76','Kabupaten Majene','KABUPATEN'),
  ('7604','76','Kabupaten Mamasa','KABUPATEN'),
  ('7605','76','Kabupaten Mamuju Tengah','KABUPATEN'),
  ('7606','76','Kabupaten Pasangkayu','KABUPATEN')
ON CONFLICT (code) DO NOTHING;

-- ── Maluku ────────────────────────────────────────────────────────────────────
-- Maluku (81)
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ('8101','81','Kabupaten Maluku Tengah','KABUPATEN'),
  ('8102','81','Kabupaten Maluku Tenggara','KABUPATEN'),
  ('8103','81','Kabupaten Maluku Barat Daya','KABUPATEN'),
  ('8104','81','Kabupaten Buru','KABUPATEN'),
  ('8105','81','Kabupaten Kepulauan Tanimbar','KABUPATEN'),
  ('8106','81','Kabupaten Seram Bagian Timur','KABUPATEN'),
  ('8107','81','Kabupaten Seram Bagian Barat','KABUPATEN'),
  ('8108','81','Kabupaten Kepulauan Aru','KABUPATEN'),
...
-- ── Papua ─────────────────────────────────────────────────────────────────────
-- Catatan: kode kab/kota untuk provinsi pemekaran Papua (92, 95, 96, 97)
-- menggunakan kode Kemendagri pasca-pemekaran 2022.
-- Verifikasi terhadap sumber resmi Kemendagri dianjurkan sebelum produksi.

-- Papua Barat (91) — setelah pemekaran Papua Barat Daya (UU 29/2022)
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ('9101','91','Kabupaten Fak-Fak','KABUPATEN'),
  ...
  ('9106','91','Kabupaten Manokwari Selatan','KABUPATEN'),
  ('9107','91','Kabupaten Pegunungan Arfak','KABUPATEN'),
  ('9108','91','Kabupaten Tambrauw','KABUPATEN')
ON CONFLICT (code) DO NOTHING;

-- Papua Barat Daya (92) — pemekaran dari Papua Barat (UU 29/2022)
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ('9201','92','Kabupaten Sorong','KABUPATEN'),
  ('9202','92','Kabupaten Sorong Selatan','KABUPATEN'),
  ('9203','92','Kabupaten Raja Ampat','KABUPATEN'),
  ('9204','92','Kabupaten Maybrat','KABUPATEN'),
  ('9271','92','Kota Sorong','KOTA')
ON CONFLICT (code) DO NOTHING;

-- Papua (94) — setelah tiga pemekaran 2022
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ('9401','94','Kabupaten Jayapura','KABUPATEN'),
  ('9402','94','Kabupaten Kepulauan Yapen','KABUPATEN'),
  ('9403','94','Kabupaten Biak Numfor','KABUPATEN'),
  ('9404','94','Kabupaten Supiori','KABUPATEN'),
  ('9405','94','Kabupaten Mamberamo Raya','KABUPATEN'),
  ('9406','94','Kabupaten Waropen','KABUPATEN'),
  ('9407','94','Kabupaten Sarmi','KABUPATEN'),
  ('9408','94','Kabupaten Keerom','KABUPATEN'),
  ('9471','94','Kota Jayapura','KOTA')
ON CONFLICT (code) DO NOTHING;

-- Papua Selatan (95) — pemekaran dari Papua (UU 14/2022)
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ('9501','95','Kabupaten Merauke','KABUPATEN'),
  ('9502','95','Kabupaten Boven Digoel','KABUPATEN'),
  ('9503','95','Kabupaten Mappi','KABUPATEN'),
  ('9504','95','Kabupaten Asmat','KABUPATEN')
ON CONFLICT (code) DO NOTHING;

-- Papua Tengah (96) — pemekaran dari Papua (UU 15/2022)
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ('9601','96','Kabupaten Nabire','KABUPATEN'),
  ('9602','96','Kabupaten Paniai','KABUPATEN'),
  ('9603','96','Kabupaten Puncak Jaya','KABUPATEN'),
  ('9604','96','Kabupaten Mimika','KABUPATEN'),
  ('9605','96','Kabupaten Dogiyai','KABUPATEN'),
  ('9606','96','Kabupaten Intan Jaya','KABUPATEN'),
  ('9607','96','Kabupaten Deiyai','KABUPATEN')
ON CONFLICT (code) DO NOTHING;

-- Papua Pegunungan (97) — pemekaran dari Papua (UU 16/2022)
INSERT INTO ref_regencies (code, province_code, name, type) VALUES
  ('9701','97','Kabupaten Jayawijaya','KABUPATEN'),
  ('9702','97','Kabupaten Yahukimo','KABUPATEN'),
  ('9703','97','Kabupaten Pegunungan Bintang','KABUPATEN'),
  ('9704','97','Kabupaten Tolikara','KABUPATEN'),
  ('9705','97','Kabupaten Nduga','KABUPATEN'),
  ('9706','97','Kabupaten Lanny Jaya','KABUPATEN'),
  ('9707','97','Kabupaten Mamberamo Tengah','KABUPATEN'),
  ('9708','97','Kabupaten Yalimo','KABUPATEN'),
  ('9709','97','Kabupaten Puncak','KABUPATEN')
ON CONFLICT (code) DO NOTHING;

-- ── Kecamatan Bandar Lampung (lengkap, 20 kecamatan) ─────────────────────────
INSERT INTO ref_districts (code, regency_code, name) VALUES
  ('1871010','1871','Telukbetung Selatan'),
  ('1871020','1871','Telukbetung Utara'),
  ('1871030','1871','Panjang'),
  ('1871040','1871','Tanjungkarang Timur'),
  ('1871050','1871','Tanjungkarang Pusat'),
  ('1871060','1871','Tanjungkarang Barat'),
  ('1871070','1871','Telukbetung Barat'),
  ('1871080','1871','Kedaton'),
  ('1871090','1871','Rajabasa'),
  ('1871100','1871','Tanjungsenang'),
  ('1871110','1871','Sukarame'),
  ('1871120','1871','Sukabumi'),
  ('1871130','1871','Kemiling'),
  ('1871140','1871','Labuhan Ratu'),
  ('1871150','1871','Way Halim'),
  ('1871160','1871','Langkapura'),
  ('1871170','1871','Enggal'),
  ('1871180','1871','Kedamaian'),
  ('1871190','1871','Telukbetung Timur'),
  ('1871200','1871','Bumi Waras')
ON CONFLICT (code) DO NOTHING;

-- Kecamatan Kota Metro (5 kecamatan)
INSERT INTO ref_districts (code, regency_code, name) VALUES
  ('1872010','1872','Metro Pusat'),
  ('1872020','1872','Metro Utara'),
  ('1872030','1872','Metro Selatan'),
  ('1872040','1872','Metro Barat'),
  ('1872050','1872','Metro Timur')
ON CONFLICT (code) DO NOTHING;

-- ── Kelurahan Kecamatan Enggal, Bandar Lampung ───────────────────────────────
INSERT INTO ref_villages (code, district_code, name, type) VALUES
  ('1871170001','1871170','Enggal','KELURAHAN'),
  ('1871170002','1871170','Pelita','KELURAHAN'),
  ('1871170003','1871170','Gunung Sari','KELURAHAN'),
  ('1871170004','1871170','Rawa Laut','KELURAHAN'),
  ('1871170005','1871170','Pasir Gintung','KELURAHAN'),
  ('1871170006','1871170','Tanjungkarang','KELURAHAN')
ON CONFLICT (code) DO NOTHING;
